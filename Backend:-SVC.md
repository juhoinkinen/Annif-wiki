...
Note that SVC cannot handle more than one class/subject per document during training. If there are more than one subject per document in the training file, a NotSupportedException is raised.
